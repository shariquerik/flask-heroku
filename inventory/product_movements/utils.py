...
def error_conditions(form, from_location, to_location, existing_only_from_location, existing_only_to_location):
    ...
    elif existing_only_from_location and ((existing_only_from_location.qty - form.qty.data) < 0):
    ...
    elif (existing_only_to_location or (from_location != "" and to_location != "" and not existing_only_to_location) or to_location == "") and not existing_only_from_location:
